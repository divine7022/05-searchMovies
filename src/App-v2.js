    ...
    <>
      ...
      <Main>
        ...
        <Box>
          ...
          {/* These are mutually exclusive statements, so any one of the statement can be true */}
          {isLoading && <Loader />}
          {!isLoading && !error && (
...
function MovieDetails({ selectedId, onCloseMovie, onAddWatched, watched }) {
  ...
  // here we are using useEffect hook to handle the side effect(coz we are intreacting with the component and the outside world )
  useEffect(
    function () {
      function callback(e) {
        if (e.code === "Escape") {
  ...
  useEffect(
    function () {
      ...
      return function () {
        ...
        // console.log(`Clean up effect for movie ${title}`);  this is nice explaination of a clouser
      };
    },
    [title]
  );
